...
int main() {
    ...
    std::cout << "C++ Analysis Service starting on port 8000..." << std::endl;
    std::cout << "This is a simplified version for testing." << std::endl;
    std::cout << "For full REST API, use the httplib version when Command Line Tools are installed." << std::endl;
    
    // Simple test
    std::string testText = "This is a wonderful and amazing post about technology. I love programming!";
    PostAnalyzer::AnalysisResult result = analyzer.analyze(testText);
    
    std::cout << "\nTest Analysis Result:" << std::endl;
    std::cout << analyzer.resultToJson(result) << std::endl;
